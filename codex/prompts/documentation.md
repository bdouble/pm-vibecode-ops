...
Ask the user to provide a linear ticket ID. Create **minimal viable documentation (MVD)** about the work related to the provided ticket ID focusing on **essential information only**, avoiding over-documentation and redundancy.

The user may also add one or more of the following when providing the Linear ticket ID:
- Doc types
- Output format
- Update strategy
...
6. **JSDoc Enhancement**: Improve existing JSDoc with better descriptions, examples, edge cases, and cross-references
7. **Missing JSDoc Addition**: Add JSDoc to any functions/classes/methods missed during implementation
8. **Type Documentation**: Enhance TypeScript interface/type documentation with detailed property descriptions
9. **Complex Algorithm Documentation**: Add detailed step-by-step explanations for complex logic
10. **External API Documentation**: Create markdown docs for REST/GraphQL endpoints with examples
11. **User Guides**: Create step-by-step tutorials only for user-facing features
12. **Architecture Docs**: Document high-level design decisions and system components
13. **Integration**: Update README with quick start and API reference links
