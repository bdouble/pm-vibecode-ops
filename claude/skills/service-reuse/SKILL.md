---
name: service-reuse
description: Prevents code duplication by enforcing service reuse. Activates when: (1) creating new services, utilities, or helper classes, (2) adding middleware, guards, or decorators, (3) creating repositories or base classes, (4) adding event handlers or infrastructure components, (5) any "I'll create a new X" pattern. ALWAYS check existing inventory before creating anything new.
---
